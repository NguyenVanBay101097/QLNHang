...
namespace WindowsFormsApp1.Luu_tru
{
    public partial class quản_lý_loại_đồ_uống : Form
    {
        ...
        List<dulieu.loainguyenlieu> dl = dulieu.dulieu.dsloainguyenlieu();
        ...
        private void btnSuaDU_Click(object sender, EventArgs e)
        {
            ...
            var du = new dulieu.loainguyenlieu();
        ...
        {
            var d = new List<dulieu.loainguyenlieu>();
            var ds = dulieu.dulieu.dsloainguyenlieu();
